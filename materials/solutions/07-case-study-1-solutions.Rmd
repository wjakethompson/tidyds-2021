---
title: 'Case Study: Friday the 13th Effect - Solutions'
output: html_notebook
editor_options: 
  chunk_output_type: inline
---

<!-- This file by Jake Thompson is licensed under a Creative Commons Attribution 4.0 International License, adapted from the orignal work at https://github.com/cwickham/data-science-in-tidyverse by Charlotte Wickham -->
...
![](`r here("resources", "bialik-fridaythe13th-2.png")`)


## Data

In the `fivethiryeight` package there are two data sets containing birth data, but for now let's just work with one `US_births_1994_2003`.  Note that since we have data from 1994-2003, our results may differ somewhat from the figure based on 1994-2014.
...
* Calculate variable of interest:
    * (For each month/year):
        ...
        * Find _percentage difference_ between births on 13th and average births on 6th and 20th
    * Average _percent difference_ by day of the week
* Create plot
...
Seem's to be driven but a particularly low number of births on the 6th of Sep 1999. Maybe a holiday effect? Labour Day was of the 6th of September that year.
...
And the code to more closely mimic the actual FiveThirtyEight graphic:
